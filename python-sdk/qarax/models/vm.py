...
class Vm(object):
    ...
    def __init__(self, address=None, host_id=None, id=None, kernel=None, kernel_params=None, memory=None, name=None, network_mode=None, status=None, vcpu=None, local_vars_configuration=None):  # noqa: E501
