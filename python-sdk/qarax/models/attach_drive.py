...
class AttachDrive(object):
    ...
    @property
    def status(self):
        """Gets the status of this AttachDrive.  # noqa: E501


        :return: The status of this AttachDrive.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this AttachDrive.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AttachDrive):
            return False
