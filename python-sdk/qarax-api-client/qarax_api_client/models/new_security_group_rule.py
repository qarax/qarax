...
T = TypeVar("T", bound="NewSecurityGroupRule")


@_attrs_define
class NewSecurityGroupRule:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Any) -> T:
        ...
        new_security_group_rule.additional_properties = d
        return new_security_group_rule
