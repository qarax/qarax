...
#[utoipa::path(
    ...
    params(crate::handlers::StorageObjectListQuery),
    responses(
...
pub async fn list(
    ...
    axum::extract::Query(query): axum::extract::Query<crate::handlers::StorageObjectListQuery>,
) -> Result<ApiResponse<Vec<StorageObject>>> {
    let objects = storage_objects::list(
        env.pool(),
        query.name.as_deref(),
        query.pool_id,
        query.object_type,
